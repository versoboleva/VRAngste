// CreateCloudsToy -> create a Cloudstoy Mngr from scrath 
...
namespace JocyfCloudsToyExample
{
	public class CreateCloudsToy : MonoBehaviour
	{
		...
		private IEnumerator Start()
		{
			...
			// Tweaking the values... after 1 second to see the changes in the editor while playing.
			TweakCloudsValues();    // Blue awfull clouds!!!
		...
		private void Update()
		{
			...
			if (_cloudsToy.CloudColor != MainColor) { _cloudsToy.CloudColor = MainColor; }
		}

		private void CreateCloudsToyInRuntime()
		{
			goCloud = gameObject;
		...
		private void AssignCloudShaders()
		{
		...
		private void AssignCloudTextures()
		{
		...
		private void TweakCloudsValues()
		{
